          ...
          >
            <div className="w-full h-full flex justify-end items-center p-10! pr-50!">
              <div className="w-full max-w-200">
                <div>
                  <div className="text-5xl font-bold items-center flex justify-center text-red-700" slot="heading">AYO DAFTAR SEKARANG!</div>
                  <div slot="description" className="text-2xl justify-center items-center flex">Saatnya Wujudkan Mimpi, Raih Masa Depan Gemilang</div>
                </div>
                <h2 className="text-center border-b border-(--line) p-3! m-2! font-bold text-2xl">Jalur pendaftaran</h2>
                <div className="grid grid-cols-3 p-3! gap-3">
                    <div className="p-5! flex justify-between text-white rounded-full bg-red-400">
                        <UserCircle/>
                        <p className="font-bold">loredsfd</p>
                    </div>
                    <div className="p-5! flex justify-between text-white rounded-full bg-red-400">
                        <UserCircle/>
                        <p className="font-bold">loredsfd</p>
              ...
              <img src={img} className="w-130 -left-18 scale-x-[-1] absolute bottom-0" alt="" />
            </div>
