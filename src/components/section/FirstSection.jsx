...
export default function FirstSection({ data }) {
  ...
  return (
    <section className="flex w-full justify-center h-screen border-(--line) border-b">
      {isMobile && (
        <div id="home" className="h-screen w-[80%] border-(--line) border-l border-r flex justify-center items-center">
          <div>
            ...
            <div className="flex justify-center items-center mt-15! from-top [--delay:1s]"></div>
          </div>
        </div>
      )}

      {isDesktop && (
        <div id="home" className="w-[80%] h-screen border-(--line) border-l border-r flex justify-center items-center">
          <div>
            <div className="relative text-(--text)">
